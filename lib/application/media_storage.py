...
class S3MediaStorage:
    ...
    def _generate_unique_video_object_name(self, trainer_user_id: str, exercise_id: str, ext: str) -> str:
        for _ in range(5):
            candidate = f"{self.videos_prefix}{trainer_user_id}/{exercise_id}/{uuid4().hex}{ext}"
